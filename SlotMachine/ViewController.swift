...
//  SlotMachine
//
//  Created by Neel Bola on 6/30/15.
...
/******************** Defining Parameters********************/
    ...
    //Stats
    var credits = 0  // track user credits
    var currentBet = 0
    var winnings = 0 // track current winnings
...
/************************************************************/
    ...
    func removeSlotImageView () {
        if self.secondContainer != nil {  //run command only if self.secondContainer is not nil
            let container: UIView? = self.secondContainer
            
            let subView:Array? = container!.subviews  // let subView:Array? - creating a constant of type array
            for view in subView! {
