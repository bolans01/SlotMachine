...
//  SlotMachine
//
//  Created by Neel Bola on 7/2/15.
...
class Factory {
    ...
    class func createSlot (currentCards : [Slot]) -> Slot { /*An array of slots is passed in */
        var currentCardValues:[Int] = [] //A container was created, which is an integer array
